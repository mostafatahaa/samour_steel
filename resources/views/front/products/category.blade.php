...
@section('section')
    <main class="common-container mobcate-main">
        ...
        <div class="breadcrumbs-nav"><a href="{{ route('home') }}">{{ __('front.home') }}</a>/<h1><a
        ...
        <div class="products-content">
            <ul class="pro-list">
                @forelse ($products as $product)
                    <li class="pro-id-203970060 list-2 list-style">
                        ...
                        <div class="pro-info">
                            ...
                            <div class="compare-action pro-id-203970060" onclick="addCache(this)">
    ...
    <div class="compare-panel">
        <div class="button-area">
            <div><button class="contact-button">{{ __('front.contact_supplier') }}</button></div>
    ...
    <script>
        function addCache(c) {
            ...
            $(c).html(
                '<input class="compare-action-check" type="checkbox" checked> <label class="checkLabel"></label> <span>Added to Inquiry</span>'
            );
